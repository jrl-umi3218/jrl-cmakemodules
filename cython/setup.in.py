...
src_files = '@CYTHON_BINDINGS_SOURCES@'.split(';')
def absolute(src):
...
class pkg_config(object):
    def __init__(self):
        ...
        self.libraries = "@CYTHON_BINDINGS_LIBRARIES@".split(";")
        self.library_dirs += [os.path.dirname(l) for l in "@CYTHON_BINDINGS_TARGET_FILES@".split(';')]
...
packages = '@CYTHON_BINDINGS_MODULES@'.split(';')
