...
MACRO(_SETUP_PROJECT_DIST)
  IF(UNIX)
    ...
    IF(APPLE)
      SET(GIT_ARCHIVE_ALL ${CMAKE_CURRENT_LIST_DIR}/git-archive-all.py)
    ELSE(APPLE)
      SET(GIT_ARCHIVE_ALL ${CMAKE_CURRENT_LIST_DIR}/git-archive-all.sh)
    ENDIF(APPLE)
    ...
    ADD_CUSTOM_TARGET(distdir
      ...
      && ${CMAKE_CURRENT_LIST_DIR}/gitlog-to-changelog >
