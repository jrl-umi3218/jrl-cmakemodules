    ...
    IF(INSTALL_DOCUMENTATION)
      ...
      FOREACH(PKG_CONFIG_STRING ${PKG_REQUIRES})
        ...
        IF( DEFINED ${PREFIX}_DOXYGENDOCDIR
          ...
          SET(DOXYGEN_TAGFILES "${DOXYGEN_TAGFILES} \"${${PREFIX}_DOXYGENDOCDIR}/${LIBRARY_NAME}.doxytag\"=\"${DEP_DOCDIR}\"")
        ENDIF()
      ENDFOREACH()
      _DOXYTAG_ENTRIES_FROM_CMAKE_DEPENDENCIES("${_PACKAGE_CONFIG_DEPENDENCIES_PROJECTS}" DOXYGEN_TAGFILES)
    ENDIF()
