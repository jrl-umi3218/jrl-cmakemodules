...
MACRO(_SETUP_PROJECT_DOCUMENTATION)
  ...
  ELSE(NOT DOXYGEN_FOUND)
    ...
    ELSE (DOXYGEN_USE_TEMPLATE_CSS)
      _set_if_undefined(DOXYGEN_HTML_FOOTER     "${CMAKE_CURRENT_LIST_DIR}/doxygen/footer.html")
      _set_if_undefined(DOXYGEN_HTML_STYLESHEET "${CMAKE_CURRENT_LIST_DIR}/doxygen/doxygen.css")
    ...
    IF("${DOXYGEN_USE_MATHJAX}" STREQUAL "YES")
      FILE(COPY ${CMAKE_CURRENT_LIST_DIR}/doxygen/MathJax
...
MACRO(_SETUP_PROJECT_DOCUMENTATION_FINALIZE)
  IF(DOXYGEN_FOUND)
    ...
    ENDIF()
    _set_if_undefined (DOXYGEN_HTML_HEADER "${CMAKE_CURRENT_LIST_DIR}/doxygen/${DOXYGEN_HEADER_NAME}")
