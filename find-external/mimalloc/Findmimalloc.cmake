...
if(NOT TARGET mimalloc)
    ...
    string(REGEX MATCH "#define[ \t]+MI_MALLOC_VERSION[ \t]+([0-9])([0-9])2" _ ${mimalloc_h})
    set(MIMALLOC_MAJOR_VERSION "${CMAKE_MATCH_1}")
    set(MIMALLOC_MINOR_VERSION "${CMAKE_MATCH_2}")
    set(MIMALLOC_PATCH_VERSION 0)
    set(mimalloc_VERSION ${MIMALLOC_MAJOR_VERSION}.${MIMALLOC_MINOR_VERSION}.${MIMALLOC_RELEASE_LEVEL})
endif()
