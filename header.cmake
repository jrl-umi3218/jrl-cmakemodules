...
MACRO(_SETUP_PROJECT_HEADER)
  ...
  IF(NOT DEFINED CUSTOM_HEADER_EXTENSION)
    SET(CUSTOM_HEADER_EXTENSION "hh")
  ENDIF(NOT DEFINED CUSTOM_HEADER_EXTENSION)
  ...
  GENERATE_CONFIGURATION_HEADER(
    ${HEADER_DIR} config.${CUSTOM_HEADER_EXTENSION} ${PACKAGE_CPPNAME}
    ${PACKAGE_CPPNAME_LOWER}_EXPORTS)

  # Generate deprecated.hh header.
  CONFIGURE_FILE(
    ${PROJECT_SOURCE_DIR}/cmake/deprecated.hh.cmake
    ${CMAKE_CURRENT_BINARY_DIR}/include/${HEADER_DIR}/deprecated.${CUSTOM_HEADER_EXTENSION}
    @ONLY
    )
  INSTALL(FILES
    ${CMAKE_CURRENT_BINARY_DIR}/include/${HEADER_DIR}/deprecated.${CUSTOM_HEADER_EXTENSION}
  ...
  CONFIGURE_FILE(
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/include/${HEADER_DIR}/warning.${CUSTOM_HEADER_EXTENSION}
    @ONLY
    )
