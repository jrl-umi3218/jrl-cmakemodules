...
macro(_SETUP_PROJECT_PACKAGE_INIT)
  ...
  set(${PROJECT_NAME}_PACKAGE_CONFIG_DEPENDENCIES_FIND_PACKAGE "" CACHE INTERNAL "")
  set(${PROJECT_NAME}_PACKAGE_CONFIG_DEPENDENCIES_FIND_DEPENDENCY "" CACHE INTERNAL "")
  set(${PROJECT_NAME}_PACKAGE_CONFIG_DEPENDENCIES_FIND_EXTERNAL "" CACHE INTERNAL "")
  set(${PROJECT_NAME}_PACKAGE_EXTRA_MACROS "" CACHE INTERNAL "")
...
macro(SETUP_PROJECT_PACKAGE_FINALIZE)
  ...
  set(PACKAGE_CONFIG_DEPENDENCIES_PROJECTS "${${PROJECT_NAME}_PACKAGE_CONFIG_DEPENDENCIES_PROJECTS}")
  set(PACKAGE_CONFIG_DEPENDENCIES_FINDE_EXTERNAL "${${PROJECT_NAME}_PACKAGE_CONFIG_DEPENDENCIES_FIND_EXTERNAL}")
  set(PACKAGE_EXTRA_MACROS "${${PROJECT_NAME}_PACKAGE_EXTRA_MACROS}")
  string(
    REPLACE
    ";"
    "\n  "
  ...
  if(DEFINED _MINIMAL_CXX_STANDARD)
    ...
    if(${MINIMAL_CXX_STANDARD_ENFORCE})
      set(
        ${PROJECT_NAME}_PACKAGE_EXTRA_MACROS
