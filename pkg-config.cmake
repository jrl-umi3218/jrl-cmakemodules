...
# .. ifmode:: internal
#
#   .. command:: _ADD_MISSING_SPACES_IN_REQUIRES
#
#     Add missing spaces in the list of required dependencies.
#
FUNCTION(_ADD_MISSING_SPACES_IN_REQUIRES PKG_CONFIG_REQUIRES_LIST)
  SET(PKG_LIST ${${PKG_CONFIG_REQUIRES_LIST}})
  STRING(REGEX REPLACE " " "" PKG_LIST ${PKG_LIST})
  STRING(REGEX REPLACE ">=" " >= " PKG_LIST ${PKG_LIST})
  STRING(REGEX REPLACE "==" " == " PKG_LIST ${PKG_LIST})
  STRING(REGEX REPLACE "<=" " <= " PKG_LIST ${PKG_LIST})
  STRING(REGEX REPLACE ">" " > " PKG_LIST ${PKG_LIST})
  ...
  STRING(REGEX REPLACE "," ", " PKG_LIST ${PKG_LIST})
  STRING(REGEX REPLACE "  " " " PKG_LIST ${PKG_LIST})
  SET(${PKG_CONFIG_REQUIRES_LIST} ${PKG_LIST} PARENT_SCOPE)
ENDFUNCTION()
...
MACRO(_SETUP_PROJECT_PKG_CONFIG_FINALIZE_DEBUG)
  ...
  _ADD_MISSING_SPACES_IN_REQUIRES(_PKG_CONFIG_REQUIRES)
  CONFIGURE_FILE(
