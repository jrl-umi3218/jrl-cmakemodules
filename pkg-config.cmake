...
MACRO(PKG_CONFIG_USE_LCOMPILE_DEPENDENCY TARGET PREFIX NO_INCLUDE_SYSTEM)
  ...
  # again.
  TARGET_INCLUDE_DIRECTORIES(${TARGET} $<$<NOT:NO_INCLUDE_SYSTEM>:SYSTEM> ${PUBLIC_KEYWORD} ${${PREFIX}_INCLUDE_DIRS})
  IF(DEFINED ${PREFIX}_DEBUG_FOUND)
    TARGET_INCLUDE_DIRECTORIES(${TARGET} $<$<NOT:NO_INCLUDE_SYSTEM>:SYSTEM> ${PUBLIC_KEYWORD} ${${PREFIX}_DEBUG_INCLUDE_DIRS})
  ENDIF()
