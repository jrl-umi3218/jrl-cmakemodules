...
MACRO(PKG_CONFIG_USE_LCOMPILE_DEPENDENCY TARGET PREFIX NO_INCLUDE_SYSTEM)
  ...
  IF(NOT ${NO_INCLUDE_SYSTEM})
    TARGET_INCLUDE_DIRECTORIES(${TARGET} SYSTEM PUBLIC ${${PREFIX}_INCLUDE_DIRS})
  ELSE()
    TARGET_INCLUDE_DIRECTORIES(${TARGET} PUBLIC ${${PREFIX}_INCLUDE_DIRS})
  ENDIF()
  IF(DEFINED ${PREFIX}_DEBUG_FOUND)
    IF(NOT ${NO_INCLUDE_SYSTEM})
      TARGET_INCLUDE_DIRECTORIES(${TARGET} SYSTEM PUBLIC ${${PREFIX}_DEBUG_INCLUDE_DIRS})
    ELSE()
      TARGET_INCLUDE_DIRECTORIES(${TARGET} PUBLIC ${${PREFIX}_DEBUG_INCLUDE_DIRS})
    ENDIF()
  ENDIF()
