...
MACRO(FINDPYTHON)
  ...
  IF("${PYTHON_EXT_SUFFIX}" STREQUAL "")
    ...
    ENDIF()
  ENDIF()
  STRING(REPLACE "." "-" PYTHON_EXT_SUFFIX_DASHES ${PYTHON_EXT_SUFFIX})
  SET(PY_PROJECT_NAME "${PROJECT_NAME}${PYTHON_EXT_SUFFIX_DASHES}")
  SET(TARGETS_EXPORT_PY_NAME "${PY_PROJECT_NAME}Targets")
