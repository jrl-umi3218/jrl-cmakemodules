...
MACRO(FINDPYTHON)
  ...
  IF(NOT CMAKE_VERSION VERSION_LESS "3.12")
    ...
    IF(DEFINED PYTHON_EXECUTABLE OR
        DEFINED Python_EXECUTABLE OR
        DEFINED Python2_EXECUTABLE OR
        DEFINED Python3_EXECUTABLE)
  ...
  IF(SEARCH_FOR_NUMPY)
    FIND_NUMPY()
    IF(PYTHON_EXPORT_DEPENDENCY)
      set(PYTHON_EXPORT_DEPENDENCY_MACROS "${PYTHON_EXPORT_DEPENDENCY_MACROS}\nFIND_NUMPY()")
    ENDIF()
  ENDIF()
