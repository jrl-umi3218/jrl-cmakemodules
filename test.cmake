...
MACRO(ADD_UNIT_TEST NAME SOURCE)
  ...
  IF(APPLE)
    ...
    SET_TESTS_PROPERTIES(${NAME} PROPERTIES ENVIRONMENT "LD_LIBRARY_PATH=$ENV{DYLD_LIBRARY_PATH}")
  ENDIF(APPLE)
...
MACRO(ADD_PYTHON_UNIT_TEST NAME SOURCE)
  ...
  IF(MODULE_PATH)
    ...
    IF(APPLE)
      SET_PROPERTY(TEST ${NAME} PROPERTY ENVIRONMENT "LD_LIBRARY_PATH=$ENV{LD_LIBRARY_PATH}")
      SET_PROPERTY(TEST ${NAME} PROPERTY ENVIRONMENT "DYLD_LIBRARY_PATH=$ENV{DYLD_LIBRARY_PATH}")
    ENDIF(APPLE)
  ENDIF(MODULE_PATH)
